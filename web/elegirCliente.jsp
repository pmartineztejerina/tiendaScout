<%-- 
    Document   : elegirCliente
    Created on : 16 ene. 2022, 18:02:21
    Author     : watanga
--%>
    ...
    <body>
        ...
        <section class="login-dark">
            <form action="listadoCliente.jsp" method="POST">
                <h2 class="visually" style="text-align: center">ELEGIR CLIENTE</h2>
                <div class="mb-2" style="text-align: center">
                <select name="usuario" style="text-align: center">
                <%
                    ArrayList<Usuario> listaUsuarios = Dao.Db.listaUsuarios();
                    for (Usuario lista : listaUsuarios) {

                    %>  
                    <option value="<%=lista.getUsuario_id() %>" required><%=lista.getUsuario_nombre() %> <%=lista.getUsuario_apellidos() %></option>                   
                    <%                        
                        }
                %>
                </div>
